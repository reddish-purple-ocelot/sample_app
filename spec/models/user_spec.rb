...
describe User do
  ...
  before { @user =  User.new(name: "Val", email: "val.slyun@gmail.com", password: "foobar", password_comfirmation: "foobar") }
  ...
  describe "when email format is valid" do
    ...
    it "should be valid" do
      adresses = %w[user@foo.COM A_US-ER@f.b.org frst.lst@foo.jp a+b@baz.cns]
